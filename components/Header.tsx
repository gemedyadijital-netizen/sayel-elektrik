...
const districts = [
  ...
  { name: 'Beykoz', slug: 'beykoz-elektrikci' },
  { name: 'Çekmeköy', slug: 'cekmekoy-elektrikci' },
  ...
  { name: 'Sancaktepe', slug: 'sancaktepe-elektrikci' },
  { name: 'Sultanbeyli', slug: 'sultanbeyli-elektrikci' },
  { name: 'Şile', slug: 'sile-elektrikci' },
  { name: 'Tuzla', slug: 'tuzla-elektrikci' },
  { name: 'Ümraniye', slug: 'umraniye-elektrikci' },
  { name: 'Üsküdar', slug: 'uskudar-elektrikci' },
  { name: 'Darıca', slug: 'darica-elektrikci' },
  { name: 'Çayırova', slug: 'cayirova-elektrikci' },
  { name: 'Gebze', slug: 'gebze-elektrikci' },
  { name: 'Dilovası', slug: 'dilovasi-elektrikci' },
];
